//
//  AddCelebrityTableViewCell.swift
//  A-List
//
...
class AddCelebrityTableViewCell: UITableViewCell {
    ...
    func configureAdd(for celebrity: CelebrityAdd) {
        nameLabel.text = celebrity.name
        profileView.image = celebrity.profileI
    }
